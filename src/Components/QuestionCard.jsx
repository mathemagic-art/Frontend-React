...
const QuestionCard = ({ id, Answer, api, Correctness }) => {
    ...
    <div className="z-10">
      <div className="w-2/3 bg-white dark:bg-dark rounded-xl m-auto mt-[10%] shadow-xl flex flex-col justify-center py-10">
        ...
        <div className="w-full flex flex-col items-center justify-center">
          <p className="text-center py-10 text-2xl text-red-500">{answer[0]}</p>
          <button className="px-6 py-2 bg-green-500 text-white rounded-md text-lg font-primary hover:bg-white hover:shadow-md hover:text-dark mr-5 duration-300">
            Show Answer
          </button>
          <p className="text-center py-10 text-2xl text-text">{answer[1]}</p>
        </div>
      </div>
    </div>
  );
