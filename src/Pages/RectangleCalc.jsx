      ...
      <div className="flex text-dark bg-white dark:bg-dark dark:text-white flex-wrap">
        ...
        <div className="mb[11.24px] ml-[114px] mt-[94px] border-2 w-[554px] h-[730px] drop-shadow-lg shadow-blur-4 shadow-spread-24 rounded-[30px] p-10 dark:bg-dark bg-bg dark:text-white text-black">
          ...
          <div>
            ...
            <label htmlFor="variable" className="ml-2 dark:text-bright text-text text-[16px]">
              Respect to
            </label>
            <input
            required
            ...
            />
            <label htmlFor="lower-limit" className="dark:text-bright text-text text-[16px]">
              Lower Limit = α
            </label>
            <input
            required
        ...
        <div className=" w-1/2 mt-12 mr-20 flex flex-col  text-tx dark:text-white">
          <p className="mt-[98px] ml-[300px] font-normal text-2xl flex">Based on Midpoint Rule's:<Newton className="fill-tx dark:fill-white ml-10 -mt-5"/></p>
          <div className="flex mt-10 ml-[300px] pt-10 h-full w-full flex-row font-normal text-2xl tracking-wide">
          <p>The answer for {!data.argument_1? "f(x)": ("f(x) = " + data.argument_2)} is: </p><div className="ml-3 pt-4 pb-14 border-2 font-normal rounded-xl text-3xl -mt-5 px-3 border-double border-green-600 h-10 text-tx dark:text-white">{answer !=="" ? answer:"_____________" }</div>
          </div>
        </div>
      </div>
    </>
