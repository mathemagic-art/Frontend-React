            ...
            <div className='flex flex-row justify-between w-full h-full z-0'>
                <div className='z-0'>
                    ...
                    <div className={style.box + "flex flex-col dark:bg-opacity-80"}>
                        ...
                        <h4 className="ml-[40px] mb-[20px] text-[18px] font-medium text-tx dark:text-primary font-inter ">Constant Multiple Rule: <MultRule className="dark:fill-white fill-black flex flex-row ml-[200px] -mt-7"/> </h4>
                        <h4 className="ml-[40px] mb-[20px] text-[18px] font-medium text-tx dark:text-primary font-inter ">Power Rule:<PowRule className="dark:fill-white fill-black flex flex-row ml-[110px] -mt-7"/></h4>
                        <h4 className="ml-[40px] mb-[20px] text-[18px] font-medium text-tx dark:text-primary font-inter ">Sum Rule:<SumRule className="dark:fill-white fill-black flex flex-row ml-[95px] -mt-7"/></h4>
                        <h4 className="ml-[40px] mb-[20px] text-[18px] font-medium text-tx dark:text-primary font-inter ">Difference Rule: <DifferenceRule className="dark:fill-white fill-black flex flex-row ml-[140px] -mt-7"/></h4>
                        <h4 className="ml-[40px] mb-[20px] text-[18px] font-medium text-tx dark:text-primary font-inter ">Product Rule: <ProductRule className="dark:fill-white fill-black flex flex-row ml-[115px] -mt-7" /></h4>
                        <h4 className="ml-[40px] mb-[20px] text-[18px] font-medium text-tx dark:text-primary font-inter ">Quotient Rule: <QuotientRule className="dark:fill-white fill-black flex flex-row ml-[125px] -mt-7" /></h4>
                    ...
                    <div className={style.box + "flex flex-col bg-opacity-95 dark:bg-opacity-80"}>
                        ...
                        <h4 className="ml-[40px] mb-[25px] text-[18px] font-medium text-tx dark:text-primary font-inter ">Simpson's Rule: <SimpRule className="dark:fill-white fill-black mt-[14px]" /></h4>
                ...
                <div className='z-20'>
                    ...
                    <h4 className="ml-[40px] mt-[50px] mb-[20px] text-[18px] font-medium text-tx dark:text-primary font-inter ">Power Rule: <PowerRule className="dark:fill-white fill-black flex flex-row ml-[110px] -mt-9"/> </h4>
                        ...
                        <h4 className="ml-[40px] mb-[15px] text-[18px] font-medium text-tx dark:text-primary font-inter ">Exponential Rule:<ExponenRule className="dark:fill-white fill-black flex flex-row ml-[150px] -mt-9"/></h4>
                        <h4 className="ml-[40px] mb-[15px] text-[18px] font-medium text-tx dark:text-primary font-inter ">Trigonometry Rule:<TrigRule className="dark:fill-white fill-black flex flex-row ml-[160px] -mt-9"/></h4>
                        <h4 className="ml-[40px] mb-[15px] text-[18px] font-medium text-tx dark:text-primary font-inter ">Trigonometry Rule: <TrigRule1 className="dark:fill-white fill-black flex flex-row ml-[160px] -mt-9"/></h4>
